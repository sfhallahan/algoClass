...
function overlapRect(rectOne, rectTwo) {
  ...
  if (rectOne.bottomY <= rectTwo.bottomY && rectOne.bottomY + rectOne.height >= rectTwo.bottomY) {
    resultRect.bottomY = rectTwo.bottomY;
  } else if (
    rectTwo.bottomY < rectOne.bottomY &&
    rectTwo.bottomY + rectTwo.height > rectOne.bottomY
  ) {
    resultRect.bottomY = rectOne.bottomY;
  } else {
    return "no y overlap";
  }
  resultRect.height =
    Math.min(rectOne.bottomY + rectOne.height, rectTwo.bottomY + rectTwo.height) -
    resultRect.bottomY;

  if (rectOne.leftX <= rectTwo.leftX && rectOne.leftX + rectOne.width >= rectTwo.leftX) {
    resultRect.leftX = rectTwo.leftX;
  } else if (rectTwo.leftX < rectOne.leftX && rectTwo.leftX + rectTwo.width > rectOne.leftX) {
    resultRect.leftX = rectOne.leftX;
  } else {
    return "no x overlap";
  }
  resultRect.width =
    Math.min(rectOne.leftX + rectOne.width, rectTwo.leftX + rectTwo.width) - resultRect.leftX;
